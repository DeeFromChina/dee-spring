...
public class BaseProvider<T, S extends IMybatiesPlusService<T>> {
    ...
    public RpcResult<Page<T>> queryPage(@RequestBody RpcRequest<T> request) {
    ...
    public RpcResult<List<T>> queryList(@RequestBody RpcRequest<T> request) {
    ...
    public RpcResult<T> queryUnique(@RequestBody RpcRequest<Serializable> request) {
    ...
    @ApiOperation("新增数据")
    @PostMapping("/add")
    public RpcResult<Void> add(@RequestBody RpcRequest<T> request) {
    ...
    public RpcResult<Void> addBatch(@RequestBody RpcRequest<List<T>> request) {
    ...
    @ApiOperation("修改数据")
    @PutMapping("/update")
    public RpcResult<Void> update(@RequestBody RpcRequest<T> request) {
    ...
    public RpcResult<Void> updateBatch(@RequestBody RpcRequest<List<T>> request) {
    ...
    public RpcResult<Void> delete(@RequestBody RpcRequest<Serializable> request) {
    ...
    public RpcResult<Void> deleteBatch(@RequestBody RpcRequest<List<Serializable>> request) {
