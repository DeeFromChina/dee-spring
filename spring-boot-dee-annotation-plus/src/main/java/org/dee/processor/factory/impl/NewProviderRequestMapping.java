...
public class NewProviderRequestMapping  implements NewRequestMappingFactory {

    public final static String extendClass = "org.dee.framework.provider.BaseProvider";
    ...
    public String createNewRequestMappingName(JCTree.JCExpression expression) {
        ...
        return StrUtil.isNotEmpty(entityName) ? "/rest/" + StrUtil.lowerFirst(entityName) : entityName;
    }
